...
public class LoggerPortBindingStub extends org.apache.axis.client.Stub implements ats.dbLogger.sources.Logger {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "logLevel"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "logDate"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ICCID"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "wsAckRsp"));
        oper.setReturnClass(ats.dbLogger.sources.WsAckRsp.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "SOAPException"),
                      "ats.dbLogger.sources.SOAPException",
                      new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "SOAPException"), 
                      true
                     ));
        _operations[0] = oper;
    ...
    public LoggerPortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public LoggerPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public LoggerPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "SOAPException");
            cachedSerQNames.add(qName);
            cls = ats.dbLogger.sources.SOAPException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "wsAckRsp");
            cachedSerQNames.add(qName);
            cls = ats.dbLogger.sources.WsAckRsp.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public ats.dbLogger.sources.WsAckRsp activityLog(java.lang.String module, java.lang.String description, java.lang.String details, java.lang.String logLevel, java.lang.String category, java.lang.String logDate, java.lang.String sessionId, java.lang.String MSISDN, java.lang.String IMSI, java.lang.String ICCID, java.lang.String instanceId) throws java.rmi.RemoteException, ats.dbLogger.sources.SOAPException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "activityLog"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {module, description, details, logLevel, category, logDate, sessionId, MSISDN, IMSI, ICCID, instanceId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (ats.dbLogger.sources.WsAckRsp) _resp;
            } catch (java.lang.Exception _exception) {
                return (ats.dbLogger.sources.WsAckRsp) org.apache.axis.utils.JavaUtils.convert(_resp, ats.dbLogger.sources.WsAckRsp.class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof ats.dbLogger.sources.SOAPException) {
              throw (ats.dbLogger.sources.SOAPException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public ats.dbLogger.sources.WsAckRsp sdrLog(java.lang.String module, java.lang.String description, java.lang.String details, java.lang.String category, java.lang.String logDate, java.lang.String sessionId, java.lang.String MSISDN, java.lang.String IMSI, java.lang.String ICCID, java.lang.String instanceId) throws java.rmi.RemoteException, ats.dbLogger.sources.SOAPException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://sources.dbLogger.ats/", "sdrLog"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {module, description, details, category, logDate, sessionId, MSISDN, IMSI, ICCID, instanceId});
